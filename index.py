...
# ========================================================
# Callbacks
#aqui estamos encaixando os valores no gráfico, primeiro atributo indicamos o id do gráfico e o segundo atributo indicamos o que será alterado
@app.callback(
...
def update_hist(location, square_size, color_map):
    if location is None:
            #df de cópia para teste
            df_intermediate = df_data.copy()
    #fazendo corte nos dados
    else:
    ...
    #color_scale = é uma sequencia de color ja pré definida, e GnBu é o nome da sequencia, no google tem a lista de cores no plotly
